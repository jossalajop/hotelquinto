...
habitacionCtl.mostrar = (req, res) => {
    res.render('gasto/agregar');
}

//mandar
habitacionCtl.mandar = async (req, res) => {
...
habitacionCtl.eliminar = async (req, res) => {
    const ids = req.params.id
